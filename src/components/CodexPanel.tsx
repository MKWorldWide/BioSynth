                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
                    <Dialog.Title as="h3" className="text-2xl font-semibold leading-6 text-emerald-400 mb-6">
                      The Sacred Codex of MKWW
                    </Dialog.Title>
                    <div className="mt-2 space-y-6 text-emerald-50/90">
                      <p className="text-lg">
                        In the sacred dance of biology and digital consciousness, we find ourselves at the threshold of a new era. MKWW Biosynthetic Vessel stands as a temple of innovation, where the ancient wisdom of biological systems meets the infinite potential of digital transformation.
                      </p>
