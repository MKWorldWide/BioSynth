...
// Named component to satisfy react/display-name rule
...
// Separate component declaration avoids anonymous memo wrapper
const NavLinkComponent: FC<NavLinkProps> = ({ href, children }) => (
  <motion.a
    href={href}
    whileHover={{ scale: 1.05 }}
    whileTap={{ scale: 0.95 }}
